      ...
      <div className="hero-content text-center">
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-base-content/70 mb-6">
            Backend-first · Full-stack capable · Always learning
          </p>
          <p className="text-base-content/60 mb-8 max-w-lg mx-auto">
            I enjoy building things, getting them running, and polishing them over time.
            Currently diving deep into backend fundamentals.
          </p>
